    ...
    public partial class Inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CodigoMedioPago = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nombre = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    BarberiaCodigoBarberia = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MediosPago", x => x.CodigoMedioPago);
                    table.ForeignKey(
                        name: "FK_MediosPago_Barberia_BarberiaCodigoBarberia",
                        column: x => x.BarberiaCodigoBarberia,
                        principalTable: "Barberia",
                        principalColumn: "CodigoBarberia");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CodigoTipoServicio = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nombre = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    BarberoCodigoBarbero = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TipoServicio", x => x.CodigoTipoServicio);
                    table.ForeignKey(
                        name: "FK_TipoServicio_Barbero_BarberoCodigoBarbero",
                        column: x => x.BarberoCodigoBarbero,
                        principalTable: "Barbero",
                        principalColumn: "CodigoBarbero");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodigoCliente = table.Column<int>(type: "int", nullable: false),
                    CodigoMedioPago = table.Column<int>(type: "int", nullable: false),
                    MedioPagoCodigoMedioPago = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cita_MediosPago_MedioPagoCodigoMedioPago",
                        column: x => x.MedioPagoCodigoMedioPago,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodigoBarberia = table.Column<int>(type: "int", nullable: false),
                    CitaCodigoCita = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Servicio_Cita_CitaCodigoCita",
                        column: x => x.CitaCodigoCita,
                        principalTable: "Cita",
                        principalColumn: "CodigoCita");
                });

            migrationBuilder.CreateTable(
                name: "ServicioTipoServicio",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServicioTipoServicio", x => new { x.ServiciosCodigoServicio, x.TipoServiciosCodigoTipoServicio });
                    table.ForeignKey(
                        name: "FK_ServicioTipoServicio_Servicio_ServiciosCodigoServicio",
                        column: x => x.ServiciosCodigoServicio,
                        principalTable: "Servicio",
                        principalColumn: "CodigoServicio",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServicioTipoServicio_TipoServicio_TipoServiciosCodigoTipoServicio",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cita_MedioPagoCodigoMedioPago",
                table: "Cita",
                column: "MedioPagoCodigoMedioPago");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MediosPago_BarberiaCodigoBarberia",
                table: "MediosPago",
                column: "BarberiaCodigoBarberia");

            migrationBuilder.CreateIndex(
                name: "IX_Servicio_CitaCodigoCita",
                table: "Servicio",
                column: "CitaCodigoCita");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServicioTipoServicio_TipoServiciosCodigoTipoServicio",
                table: "ServicioTipoServicio",
                column: "TipoServiciosCodigoTipoServicio");

            migrationBuilder.CreateIndex(
                name: "IX_TipoServicio_BarberoCodigoBarbero",
                table: "TipoServicio",
                column: "BarberoCodigoBarbero");
        }
