...
namespace Barberiapp.Migrations
{
    ...
    [Migration("20221123191633_CorreccionTipo")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Barberiapp.Entidades.ServiciosCita", b =>
                {
                    b.Property<int>("CodigoCita")
                        .HasColumnType("int");
                    ...
                    b.HasKey("CodigoCita", "CodigoServicio");

                    b.HasIndex("CodigoServicio");

                    b.ToTable("ServiciosCita");
                });
            ...
            modelBuilder.Entity("ServicioTipoServicio", b =>
                {
                    ...
                    b.ToTable("TipoServiciosIncluidos", (string)null);
                });
            ...
            modelBuilder.Entity("Barberiapp.Entidades.ServiciosCita", b =>
                {
                    b.HasOne("Barberiapp.Entidades.Cita", "Cita")
                        .WithMany("ServiciosCita")
                        .HasForeignKey("CodigoCita")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Barberiapp.Entidades.Servicio", "Servicio")
                        .WithMany("ServiciosCita")
